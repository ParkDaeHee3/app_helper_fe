...
class MedicineDetailActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // TabLayout에 탭 추가 (동적 추가)
        //binding.tabsMedicineDetail.addTab(binding.tabsMedicineDetail.newTab().setText("효능"))
        //binding.tabsMedicineDetail.addTab(binding.tabsMedicineDetail.newTab().setText("사용법"))
        //binding.tabsMedicineDetail.addTab(binding.tabsMedicineDetail.newTab().setText("보관"))
        //binding.tabsMedicineDetail.addTab(binding.tabsMedicineDetail.newTab().setText("주의"))

        // 처음에는 "효능" 탭에 해당하는 데이터만 표시하도록 설정
        val initialDetails = details.filter { it.category == "효능" }
        ...
        toolbar.setNavigationOnClickListener {
            onBackPressedDispatcher.onBackPressed() // 뒤로가기 동작
        }
    }
